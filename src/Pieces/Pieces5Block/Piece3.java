...
public class Piece3 extends Piece {
    ...
    private static final int pieceNumber = 3;

    public Piece3(Field field, int offset) {
        super(new Square(new Point2D.Double(offset - 1, 0), COLOR,pieceNumber), new Square(new Point2D.Double(offset, 0), COLOR,pieceNumber), new Square(new Point2D.Double(offset, 1), COLOR,pieceNumber), new Square(new Point2D.Double(offset, 2), COLOR,pieceNumber), new Square(new Point2D.Double(offset, 3), COLOR,pieceNumber), field);
    }
