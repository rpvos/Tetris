...
public class Piece1 extends Piece {
    ...
    public Piece1(Field field, int offset) {
        super(new Square(new Point2D.Double(offset,0), COLOR), new Square(new Point2D.Double(offset, 1), COLOR), new Square(new Point2D.Double(offset, 2), COLOR), new Square(new Point2D.Double(offset+1, 0), COLOR), new Square(new Point2D.Double(offset+1, 1), COLOR), field);
    }
