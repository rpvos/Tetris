...
public class Piece2 extends Piece {
    ...
    public Piece2(Field field, int offset) {
        super(new Square(new Point2D.Double(offset - 2, 0), COLOR), new Square(new Point2D.Double(offset - 1, 0), COLOR), new Square(new Point2D.Double(offset, 0), COLOR), new Square(new Point2D.Double(offset + 1, 0), COLOR), new Square(new Point2D.Double(offset + 2, 0), COLOR), field);
    }
