...
public class Piece4 extends Piece {
    ...
    public Piece4(Field field, int offset) {
        super(new Square(new Point2D.Double(offset , 0), COLOR), new Square(new Point2D.Double(offset-1, 0), COLOR), new Square(new Point2D.Double(offset-1, 1), COLOR), new Square(new Point2D.Double(offset-1, 2), COLOR), new Square(new Point2D.Double(offset-1, 3), COLOR), field);
    }
